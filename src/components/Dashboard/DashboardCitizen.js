            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Soumettre un Rapport</span>
                </Link>
                <Link
                  to="/view-reports"
                  className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:bg-gray-50 transition-colors"
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Mes Rapports</span>
                </Link>
                <Link
                  to="/community-forum"
                  className="flex flex-col items-center justify-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:bg-gray-50 transition-colors"
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Forum Communautaire</span>
                </Link>
              </div>
            </div>
          </div>
